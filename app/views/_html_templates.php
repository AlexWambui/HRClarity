    ...
    ?>
        <section class="side_navbar">
            ...
            <ul class="nav_links">
                ...
                <li><a href="payslip.php"><span class="icon icon-money"></span> <span>Payslip</span></a></li>
            </ul>
            <ul class="footer">
                <li>
                    <a href="update_profile.php?id=<?= $_SESSION['user_id'] ?>" class="btn btn-sm mr-2">
                        <img src="<?= $_SESSION["user_profile_picture"] ?>" alt="Profile Picture" class="<?php if ($_SESSION['user_status'] == 1) echo "verified"; else echo "unverified" ?>" />
                    </a>
                </li>
                <li>
                    <a href="update_profile.php?id=<?= $_SESSION['user_id'] ?>" class="btn btn-sm mr-2">
