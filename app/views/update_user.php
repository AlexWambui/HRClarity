            ...
            <div class="body">
                <?php foreach (fetch_user($_REQUEST['id']) as $user) : ?>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="occupation_id" id="occupation_id" class="custom-select" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_level" id="user_level" class="custom-select">
                                        <option value="<?= $user['user_level_id'] ?>">
                                            <?php
                                            if ($user['user_level_id'] == 1) echo "Employee";
                                            elseif ($user['user_level'] == 2) echo "HR Manager";
                                            else echo "Database Admin";
                                            ?>
                                        </option>
                        ...
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-success btn-block" name="update_user">Update</button>
                            </div>
                            <div class="col">
