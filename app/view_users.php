                ...
                <table id="example" class="table table-hover">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <a href="update.php?id=<?= $user["id"]?>"><span class="text-success table_icons icon-pencil"></span></a> |
                                <a href="archive.php?id=<?= $user["id"]?>"><span class="text-warning table_icons icon-archive"></span></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
